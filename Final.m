function [t,VAR,Output] = Final
%===========================================================================
% File: Final.m created Dec 08 2021 by MotionGenesis 6.1.
...
+ g*LC*me*sin(qc) + g*LD*mBox*cos(qd) + g*LD*me*cos(qd) + g*LE*mBox*cos(qe) + g*ma*LACM*sin(qa) + g*mc*LCCM*sin(qc) + g*md*LDCM*cos(qd)  ...
+ g*me*LECM*cos(qe) + LA*mb*LBCM*sin(qa+qb)*qaDt^2 + LB*mc*(LA*sin(qa+qb)*qaDt^2+LCCM*sin(qb+qc)*qcDt^2) + LB*md*(LA*sin(qa+qb)*qaDt^2+  ...
LC*sin(qb+qc)*qcDt^2+LDCM*cos(qb-qd)*qdDt^2) + LB*mBox*(LA*sin(qa+qb)*qaDt^2+LC*sin(qb+qc)*qcDt^2+LD*cos(qb-qd)*qdDt^2+LE*cos(qb-  ...
qe)*qeDt^2) + LB*me*(LA*sin(qa+qb)*qaDt^2+LC*sin(qb+qc)*qcDt^2+LD*cos(qb-qd)*qdDt^2+LECM*cos(qb-qe)*qeDt^2) + (Ie+mBox*LE^2+me*LECM^2)*qeDDt  ...
+ LA*(LE*mBox+me*LECM)*sin(qa+qe)*qeDDt + LC*(LE*mBox+me*LECM)*sin(qc+qe)*qeDDt + LD*(LE*mBox+me*LECM)*cos(qd-qe)*qdDDt  ...
+ LD*(LE*mBox+me*LECM)*cos(qd-qe)*qeDDt + (Id+mBox*LD^2+me*LD^2+md*LDCM^2)*qdDDt + LA*(LD*mBox+LD*me+md*LDCM)*sin(qa+qd)*qdDDt  ...
+ LC*(LD*mBox+LD*me+md*LDCM)*sin(qc+qd)*qdDDt + LB*(LC*mBox+LC*md+LC*me+mc*LCCM)*cos(qb+qc)*qbDDt + LA*(LB*mBox+LB*mc+LB*md+LB*me+  ...
mb*LBCM)*cos(qa+qb)*qbDDt + (Ib+mBox*LB^2+mc*LB^2+md*LB^2+me*LB^2+mb*LBCM^2)*qbDDt - g*LB*mBox*sin(qb) - g*LB*mc*sin(qb)  ...
- g*LB*md*sin(qb) - g*LB*me*sin(qb) - g*mb*LBCM*sin(qb) - mc*LCCM*(LB*sin(qb+qc)*qbDt^2-LA*sin(qa-qc)*qaDt^2) - md*LDCM*(LA*cos(qa+  ...
qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2) - LC*md*(LB*sin(qb+qc)*qbDt^2-LDCM*cos(qc+qd)*qdDt^2-LA*sin(qa-qc)*qaDt^2)  ...
- LD*mBox*(LA*cos(qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2-LE*sin(qd-qe)*qeDt^2) - LD*me*(LA*cos(qa+qd)*qaDt^2+LC*  ...
cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2-LECM*sin(qd-qe)*qeDt^2) - LC*mBox*(LB*sin(qb+qc)*qbDt^2-LD*cos(qc+qd)*qdDt^2-LE*cos(qc+qe)*qeDt^2-  ...
LA*sin(qa-qc)*qaDt^2) - LC*me*(LB*sin(qb+qc)*qbDt^2-LD*cos(qc+qd)*qdDt^2-LECM*cos(qc+qe)*qeDt^2-LA*sin(qa-qc)*qaDt^2) - (LE*mBox+  ...
me*LECM)*(LA*cos(qa+qe)*qaDt^2+LC*cos(qc+qe)*qcDt^2+LB*cos(qb-qe)*qbDt^2+LD*sin(qd-qe)*qdDt^2) - LA*(mb*LBCM*sin(qa+qb)*qbDt^2+mc*(  ...
LB*sin(qa+qb)*qbDt^2+LCCM*sin(qa-qc)*qcDt^2)-md*(LDCM*cos(qa+qd)*qdDt^2-LB*sin(qa+qb)*qbDt^2-LC*sin(qa-qc)*qcDt^2)-mBox*(LD*cos(qa+  ...
qd)*qdDt^2+LE*cos(qa+qe)*qeDt^2-LB*sin(qa+qb)*qbDt^2-LC*sin(qa-qc)*qcDt^2)-me*(LD*cos(qa+qd)*qdDt^2+LECM*cos(qa+qe)*qeDt^2-LB*sin(  ...
qa+qb)*qbDt^2-LC*sin(qa-qc)*qcDt^2)) - LA*(LE*mBox+me*LECM)*sin(qa+qe)*qaDDt - LC*(LE*mBox+me*LECM)*sin(qc+qe)*qcDDt - LB*(LE*mBox+  ...
me*LECM)*sin(qb-qe)*qbDDt - LB*(LE*mBox+me*LECM)*sin(qb-qe)*qeDDt - LA*(LD*mBox+LD*me+md*LDCM)*sin(qa+qd)*qaDDt - LC*(LD*mBox+LD*  ...
me+md*LDCM)*sin(qc+qd)*qcDDt - LB*(LD*mBox+LD*me+md*LDCM)*sin(qb-qd)*qbDDt - LB*(LD*mBox+LD*me+md*LDCM)*sin(qb-qd)*qdDDt  ...
- LB*(LC*mBox+LC*md+LC*me+mc*LCCM)*cos(qb+qc)*qcDDt - (Ic+mBox*LC^2+md*LC^2+me*LC^2+mc*LCCM^2)*qcDDt - LA*(LC*mBox+LC*md+LC*me+mc*  ...
LCCM)*cos(qa-qc)*qaDDt - LA*(LC*mBox+LC*md+LC*me+mc*LCCM)*cos(qa-qc)*qcDDt - LA*(LB*mBox+LB*mc+LB*md+LB*me+mb*LBCM)*cos(qa+qb)*qaDDt  ...
- (Ia+mb*LA^2+mBox*LA^2+mc*LA^2+md*LA^2+me*LA^2+ma*LACM^2)*qaDDt;
TBA = g*LC*mBox*sin(qc) + g*LC*md*sin(qc) + g*LC*me*sin(qc) + g*LD*mBox*cos(qd) + g*LD*me*cos(qd) + g*LE*mBox*cos(qe) + g*mc*LCCM*sin(qc)  ...
+ g*md*LDCM*cos(qd) + g*me*LECM*cos(qe) + LA*mb*LBCM*sin(qa+qb)*qaDt^2 + LB*mc*(LA*sin(qa+qb)*qaDt^2+LCCM*sin(qb+qc)*qcDt^2)  ...
+ LB*md*(LA*sin(qa+qb)*qaDt^2+LC*sin(qb+qc)*qcDt^2+LDCM*cos(qb-qd)*qdDt^2) + LB*mBox*(LA*sin(qa+qb)*qaDt^2+LC*sin(qb+qc)*qcDt^2+LD*  ...
cos(qb-qd)*qdDt^2+LE*cos(qb-qe)*qeDt^2) + LB*me*(LA*sin(qa+qb)*qaDt^2+LC*sin(qb+qc)*qcDt^2+LD*cos(qb-qd)*qdDt^2+LECM*cos(qb-qe)*qeDt^2)  ...
+ (Ie+mBox*LE^2+me*LECM^2)*qeDDt + LC*(LE*mBox+me*LECM)*sin(qc+qe)*qeDDt + LD*(LE*mBox+me*LECM)*cos(qd-qe)*qdDDt + LD*(LE*mBox+me*  ...
LECM)*cos(qd-qe)*qeDDt + (Id+mBox*LD^2+me*LD^2+md*LDCM^2)*qdDDt + LC*(LD*mBox+LD*me+md*LDCM)*sin(qc+qd)*qdDDt + LB*(LC*mBox+LC*md+  ...
LC*me+mc*LCCM)*cos(qb+qc)*qbDDt + (Ib+mBox*LB^2+mc*LB^2+md*LB^2+me*LB^2+mb*LBCM^2)*qbDDt - g*LB*mBox*sin(qb) - g*LB*mc*sin(qb)  ...
- g*LB*md*sin(qb) - g*LB*me*sin(qb) - g*mb*LBCM*sin(qb) - mc*LCCM*(LB*sin(qb+qc)*qbDt^2-LA*sin(qa-qc)*qaDt^2) - md*LDCM*(LA*cos(qa+  ...
qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2) - LC*md*(LB*sin(qb+qc)*qbDt^2-LDCM*cos(qc+qd)*qdDt^2-LA*sin(qa-qc)*qaDt^2)  ...
- LD*mBox*(LA*cos(qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2-LE*sin(qd-qe)*qeDt^2) - LD*me*(LA*cos(qa+qd)*qaDt^2+LC*  ...
cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2-LECM*sin(qd-qe)*qeDt^2) - LC*mBox*(LB*sin(qb+qc)*qbDt^2-LD*cos(qc+qd)*qdDt^2-LE*cos(qc+qe)*qeDt^2-  ...
LA*sin(qa-qc)*qaDt^2) - LC*me*(LB*sin(qb+qc)*qbDt^2-LD*cos(qc+qd)*qdDt^2-LECM*cos(qc+qe)*qeDt^2-LA*sin(qa-qc)*qaDt^2) - (LE*mBox+  ...
me*LECM)*(LA*cos(qa+qe)*qaDt^2+LC*cos(qc+qe)*qcDt^2+LB*cos(qb-qe)*qbDt^2+LD*sin(qd-qe)*qdDt^2) - LA*(LE*mBox+me*LECM)*sin(qa+qe)*qaDDt  ...
- LC*(LE*mBox+me*LECM)*sin(qc+qe)*qcDDt - LB*(LE*mBox+me*LECM)*sin(qb-qe)*qbDDt - LB*(LE*mBox+me*LECM)*sin(qb-qe)*qeDDt  ...
...
- LB*(LD*mBox+LD*me+md*LDCM)*sin(qb-qd)*qdDDt - LB*(LC*mBox+LC*md+LC*me+mc*LCCM)*cos(qb+qc)*qcDDt - (Ic+mBox*LC^2+md*LC^2+me*LC^2+  ...
mc*LCCM^2)*qcDDt - LA*(LC*mBox+LC*md+LC*me+mc*LCCM)*cos(qa-qc)*qaDDt - LA*(LB*mBox+LB*mc+LB*md+LB*me+mb*LBCM)*cos(qa+qb)*qaDDt;
TCB = g*LC*mBox*sin(qc) + g*LC*md*sin(qc) + g*LC*me*sin(qc) + g*LD*mBox*cos(qd) + g*LD*me*cos(qd) + g*LE*mBox*cos(qe) + g*mc*LCCM*sin(qc)  ...
+ g*md*LDCM*cos(qd) + g*me*LECM*cos(qe) + (Ie+mBox*LE^2+me*LECM^2)*qeDDt + LC*(LE*mBox+me*LECM)*sin(qc+qe)*qeDDt + LD*(LE*mBox+me*  ...
LECM)*cos(qd-qe)*qdDDt + LD*(LE*mBox+me*LECM)*cos(qd-qe)*qeDDt + (Id+mBox*LD^2+me*LD^2+md*LDCM^2)*qdDDt + LC*(LD*mBox+LD*me+md*LDCM)*  ...
sin(qc+qd)*qdDDt + LB*(LC*mBox+LC*md+LC*me+mc*LCCM)*cos(qb+qc)*qbDDt - mc*LCCM*(LB*sin(qb+qc)*qbDt^2-LA*sin(qa-qc)*qaDt^2)  ...
- md*LDCM*(LA*cos(qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2) - LC*md*(LB*sin(qb+qc)*qbDt^2-LDCM*cos(qc+qd)*qdDt^2-LA*  ...
sin(qa-qc)*qaDt^2) - LD*mBox*(LA*cos(qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2-LE*sin(qd-qe)*qeDt^2) - LD*me*(LA*cos(  ...
qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2-LECM*sin(qd-qe)*qeDt^2) - LC*mBox*(LB*sin(qb+qc)*qbDt^2-LD*cos(qc+qd)*qdDt^2-  ...
LE*cos(qc+qe)*qeDt^2-LA*sin(qa-qc)*qaDt^2) - LC*me*(LB*sin(qb+qc)*qbDt^2-LD*cos(qc+qd)*qdDt^2-LECM*cos(qc+qe)*qeDt^2-LA*sin(qa-qc)*qaDt^2)  ...
- (LE*mBox+me*LECM)*(LA*cos(qa+qe)*qaDt^2+LC*cos(qc+qe)*qcDt^2+LB*cos(qb-qe)*qbDt^2+LD*sin(qd-qe)*qdDt^2) - LA*(LE*mBox+me*LECM)*  ...
sin(qa+qe)*qaDDt - LC*(LE*mBox+me*LECM)*sin(qc+qe)*qcDDt - LB*(LE*mBox+me*LECM)*sin(qb-qe)*qbDDt - LA*(LD*mBox+LD*me+md*LDCM)*sin(  ...
qa+qd)*qaDDt - LC*(LD*mBox+LD*me+md*LDCM)*sin(qc+qd)*qcDDt - LB*(LD*mBox+LD*me+md*LDCM)*sin(qb-qd)*qbDDt - (Ic+mBox*LC^2+md*LC^2+  ...
me*LC^2+mc*LCCM^2)*qcDDt - LA*(LC*mBox+LC*md+LC*me+mc*LCCM)*cos(qa-qc)*qaDDt;
TDC = g*LD*mBox*cos(qd) + g*LD*me*cos(qd) + g*LE*mBox*cos(qe) + g*md*LDCM*cos(qd) + g*me*LECM*cos(qe) + (Ie+mBox*LE^2+me*LECM^2)*qeDDt  ...
+ LD*(LE*mBox+me*LECM)*cos(qd-qe)*qdDDt + LD*(LE*mBox+me*LECM)*cos(qd-qe)*qeDDt + (Id+mBox*LD^2+me*LD^2+md*LDCM^2)*qdDDt  ...
- md*LDCM*(LA*cos(qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2) - LD*mBox*(LA*cos(qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*  ...
cos(qb-qd)*qbDt^2-LE*sin(qd-qe)*qeDt^2) - LD*me*(LA*cos(qa+qd)*qaDt^2+LC*cos(qc+qd)*qcDt^2+LB*cos(qb-qd)*qbDt^2-LECM*sin(qd-qe)*qeDt^2)  ...
- (LE*mBox+me*LECM)*(LA*cos(qa+qe)*qaDt^2+LC*cos(qc+qe)*qcDt^2+LB*cos(qb-qe)*qbDt^2+LD*sin(qd-qe)*qdDt^2) - LA*(LE*mBox+me*LECM)*  ...
sin(qa+qe)*qaDDt - LC*(LE*mBox+me*LECM)*sin(qc+qe)*qcDDt - LB*(LE*mBox+me*LECM)*sin(qb-qe)*qbDDt - LA*(LD*mBox+LD*me+md*LDCM)*sin(  ...
qa+qd)*qaDDt - LC*(LD*mBox+LD*me+md*LDCM)*sin(qc+qd)*qcDDt - LB*(LD*mBox+LD*me+md*LDCM)*sin(qb-qd)*qbDDt;
TED = g*LE*mBox*cos(qe) + g*me*LECM*cos(qe) + (Ie+mBox*LE^2+me*LECM^2)*qeDDt + LD*(LE*mBox+me*LECM)*cos(qd-qe)*qdDDt - (LE*mBox+me*  ...
LECM)*(LA*cos(qa+qe)*qaDt^2+LC*cos(qc+qe)*qcDt^2+LB*cos(qb-qe)*qbDt^2+LD*sin(qd-qe)*qdDt^2) - LA*(LE*mBox+me*LECM)*sin(qa+qe)*qaDDt  ...
- LC*(LE*mBox+me*LECM)*sin(qc+qe)*qcDDt - LB*(LE*mBox+me*LECM)*sin(qb-qe)*qbDDt;
...
if( isempty(Output) ),
   if( ~isempty(FileIdentifier) ),
      ...
      fprintf( 1, '\n Output is in the files Final.i  (i=1,2)\n\n' );
   end
...
if( isempty(hasHeaderInformationBeenWritten) ),
   ...
   if( shouldPrintToFile && isempty(FileIdentifier) ),
      ...
      FileIdentifier(1) = fopen('Final.1', 'wt');   if( FileIdentifier(1) == -1 ), error('Error: unable to open file Final.1'); end
      fprintf(FileIdentifier(1), '%% FILE: Final.1\n%%\n' );
      fprintf(FileIdentifier(1), '%%       t             qa             qb             qc             qd             qe\n' );
      fprintf(FileIdentifier(1), '%%     (sec)          (deg)          (deg)          (deg)          (deg)          (deg)\n\n' );
      FileIdentifier(2) = fopen('Final.2', 'wt');   if( FileIdentifier(2) == -1 ), error('Error: unable to open file Final.2'); end
      fprintf(FileIdentifier(2), '%% FILE: Final.2\n%%\n' );
